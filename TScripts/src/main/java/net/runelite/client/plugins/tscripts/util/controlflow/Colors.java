...
/**
 * Class to store colors for the syntax highlighting
 */
public class Colors
{
    public static final String CURRENT = "#424242";
    public static final String HIGHLIGHT = "#E6E6FA";
    ...
    public static final String BACKGROUND_CURRENT = "#026178";
